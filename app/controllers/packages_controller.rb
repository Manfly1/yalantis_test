...
class PackagesController < ApplicationController
  ...
  def destroy
    ...
    if @package.destroy
      flash[:success] = "Package #{@package.tracking_number} deleted."
    else
      flash[:error] = "Package #{@package.tracking_number} not be deleted."
    end
    redirect_to @courier
  end
  ...
  def complete
    ...
    redirect_to @courier, notice: "Status 'Completed'"
  end
